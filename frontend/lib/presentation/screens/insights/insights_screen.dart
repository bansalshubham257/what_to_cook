...
class _InsightsScreenState extends ConsumerState<InsightsScreen> {
  ...
  Map<String, dynamic> get _stats =>
      _selectedPeriod == 'month' && _monthlyData != null
          ? _monthlyData!
          : _weeklyData ?? {};
  ...
  String get _periodLabel =>
      _selectedPeriod == 'week' ? 'Your Last 7 Days' : 'This Month';
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (_selectedPeriod == 'week') {
        _weeklyData = (await apiClient.get(ApiConstants.weeklyInsights)).data
      ...
      _balanceData = (await apiClient.get(ApiConstants.balance)).data
          as Map<String, dynamic>;
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(insightsRefreshProvider, (_, __) => _loadData());
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _healthBar('Balanced', _balancedPercent / 100,
                                    Colors.green),
                                const SizedBox(height: 12),
                                _healthBar('Moderate', _moderatePercent / 100,
                                    Colors.orange),
                                const SizedBox(height: 12),
                                _healthBar('Indulgent', _indulgentPercent / 100,
                                    Colors.red),
                                const SizedBox(height: 16),
                                Row(
                                  mainAxisAlignment:
                                  ...
                                  children: [
                                    _statItem('${_balancedPercent.toInt()}%',
                                        'Balanced', Colors.green),
                                    _statItem('${_moderatePercent.toInt()}%',
                                        'Moderate', Colors.orange),
                                    _statItem('${_indulgentPercent.toInt()}%',
                                        'Indulgent', Colors.red),
                                  ],
                                ),
                              ],
                            ),
  ...
  Widget _buildCuisineDistribution() {
    ...
    if (cuisines.isEmpty) {
      return const Text('No cuisine data available',
